...
const staticFormsKey = config.public.staticFormsKey;
console.log(staticFormsKey);
    ...
    <div class="pb-24 pt-16 sm:pb-32 sm:pt-24 lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2 lg:pt-32">
      <div class="px-6 lg:px-8">
        <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
          ...
          <form action="https://api.staticforms.xyz/submit" method="post" class="mt-16">
            <input type="hidden" name="redirectTo" :value="url.origin + '/contact/success'" />
            <input type="text" name="honeypot" style="display: none" />
            <input type="hidden" name="accessKey" :value="staticFormsKey" />
